...
//!
//! ```
//! use fae_core::terminal::{detect, detect_capabilities, MockQuerier};
//!
...
//!
//! ```
//! use fae_core::terminal::{ColorSupport, MockQuerier, TerminalKind, MultiplexerKind, detect_capabilities};
//!
//! let mut querier = MockQuerier::new()
