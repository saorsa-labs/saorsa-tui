...
use fae_core::buffer::{CellChange, ScreenBuffer};
use fae_core::cell::Cell;
use fae_core::color::{Color, NamedColor};
use fae_core::geometry::Size;
use fae_core::renderer::{Renderer, build_sgr_sequence};
use fae_core::style::Style;
use fae_core::terminal::multiplexer::wrap_sequence;
...
fn test_multiplexer_limits_applied() {
    use fae_core::terminal::merge_multiplexer_limits;
