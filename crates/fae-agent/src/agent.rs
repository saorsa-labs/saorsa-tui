                ...
                match event {
                    ...
                    Ok(StreamEvent::Error { message }) => {
                        ...
                        let _ = self
                            ...
                            .await;
                        return Err(FaeAgentError::Internal(message));
                    }
                    _ => {}
                }
            }
...
mod tests {
    ...
    impl fae_ai::Provider for MockProvider {
        async fn complete(
            &self,
            _request: CompletionRequest,
        ) -> fae_ai::Result<fae_ai::CompletionResponse> {
            Err(fae_ai::FaeAiError::Internal("not implemented".into()))
        }
    }
    ...
    impl StreamingProvider for MockProvider {
        async fn stream(
            &self,
            _request: CompletionRequest,
        ) -> fae_ai::Result<tokio::sync::mpsc::Receiver<fae_ai::Result<StreamEvent>>> {
