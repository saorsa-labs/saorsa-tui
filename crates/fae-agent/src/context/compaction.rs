...
use fae_ai::message::Message;
use fae_ai::tokens::{estimate_conversation_tokens, estimate_message_tokens};
...
///
/// Note: fae-ai Message doesn't have a "system" role - system prompts are separate.
...
fn truncate_oldest(
    ...
    let system_tokens = system.map_or(0, fae_ai::tokens::estimate_tokens);
...
mod tests {
    use super::*;
    use fae_ai::message::{Message, Role};
