...
**Files**:
- `crates/fae-core/src/terminal/detect.rs`
- `crates/fae-core/src/terminal/mod.rs` (re-export)
...
**Files**:
- `crates/fae-core/src/terminal/profiles.rs`
- `crates/fae-core/src/terminal/traits.rs` (extend TerminalCapabilities)
...
**Files**:
- `crates/fae-core/src/terminal/query.rs`
...
**Files**:
- `crates/fae-core/src/renderer.rs` (enhance existing color downgrade)
...
**Files**:
- `crates/fae-core/src/terminal/multiplexer.rs`
...
**Files**:
- `crates/fae-core/src/terminal/crossterm_backend.rs`
...
**Files**:
- `crates/fae-core/tests/terminal_compat.rs`
...
**Files**:
- `crates/fae-core/tests/terminal_integration.rs`
- `crates/fae-core/src/terminal/mod.rs` (module docs)
